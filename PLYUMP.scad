...
cierre_lateral( altura , radio_exterior , radio_interior ,
...
module cierre_lateral( altura , radio_exterior , radio_interior , ancho_boquilla, largo_boquilla , radio_bisagra , diametro_tornillo , radio_tubo , suavizar_salida_tubo )
{
    difference(){
        union(){
        // Cuerpo
